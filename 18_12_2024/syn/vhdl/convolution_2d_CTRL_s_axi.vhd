...
entity convolution_2d_CTRL_s_axi is
generic (
...
end entity convolution_2d_CTRL_s_axi;
...
--         others - reserved
-- 0x040 ~
-- 0x07f : Memory 'input_0' (12 * 32b)
--         Word n : bit [31:0] - input_0[n]
-- 0x080 ~
-- 0x0bf : Memory 'input_1' (12 * 32b)
--         Word n : bit [31:0] - input_1[n]
-- 0x0c0 ~
-- 0x0ff : Memory 'input_2' (12 * 32b)
--         Word n : bit [31:0] - input_2[n]
-- 0x100 ~
-- 0x10f : Memory 'kernel_0' (3 * 32b)
--         Word n : bit [31:0] - kernel_0[n]
-- 0x110 ~
-- 0x11f : Memory 'kernel_1' (3 * 32b)
--         Word n : bit [31:0] - kernel_1[n]
-- 0x120 ~
-- 0x12f : Memory 'kernel_2' (3 * 32b)
--         Word n : bit [31:0] - kernel_2[n]
-- 0x140 ~
-- 0x17f : Memory 'output_r' (16 * 32b)
--         Word n : bit [31:0] - output_r[n]
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of convolution_2d_CTRL_s_axi is
    ...
    constant ADDR_KERNEL_0_BASE : INTEGER := 16#100#;
    constant ADDR_KERNEL_0_HIGH : INTEGER := 16#10f#;
    constant ADDR_KERNEL_1_BASE : INTEGER := 16#110#;
    constant ADDR_KERNEL_1_HIGH : INTEGER := 16#11f#;
    constant ADDR_KERNEL_2_BASE : INTEGER := 16#120#;
    constant ADDR_KERNEL_2_HIGH : INTEGER := 16#12f#;
    ...
    signal int_input_2_address0 : UNSIGNED(3 downto 0);
    ...
    signal int_input_2_address1 : UNSIGNED(3 downto 0);
    ...
    signal int_kernel_0_address0 : UNSIGNED(1 downto 0);
    signal int_kernel_0_ce0    : STD_LOGIC;
    signal int_kernel_0_we0    : STD_LOGIC;
    signal int_kernel_0_be0    : UNSIGNED(3 downto 0);
    signal int_kernel_0_d0     : UNSIGNED(31 downto 0);
    signal int_kernel_0_q0     : UNSIGNED(31 downto 0);
    signal int_kernel_0_address1 : UNSIGNED(1 downto 0);
    signal int_kernel_0_ce1    : STD_LOGIC;
    signal int_kernel_0_we1    : STD_LOGIC;
    signal int_kernel_0_be1    : UNSIGNED(3 downto 0);
    signal int_kernel_0_d1     : UNSIGNED(31 downto 0);
    signal int_kernel_0_q1     : UNSIGNED(31 downto 0);
    signal int_kernel_0_read   : STD_LOGIC;
    signal int_kernel_0_write  : STD_LOGIC;
    signal int_kernel_1_address0 : UNSIGNED(1 downto 0);
    signal int_kernel_1_ce0    : STD_LOGIC;
    signal int_kernel_1_we0    : STD_LOGIC;
    signal int_kernel_1_be0    : UNSIGNED(3 downto 0);
    signal int_kernel_1_d0     : UNSIGNED(31 downto 0);
    signal int_kernel_1_q0     : UNSIGNED(31 downto 0);
    signal int_kernel_1_address1 : UNSIGNED(1 downto 0);
    signal int_kernel_1_ce1    : STD_LOGIC;
    signal int_kernel_1_we1    : STD_LOGIC;
    signal int_kernel_1_be1    : UNSIGNED(3 downto 0);
    signal int_kernel_1_d1     : UNSIGNED(31 downto 0);
    signal int_kernel_1_q1     : UNSIGNED(31 downto 0);
    signal int_kernel_1_read   : STD_LOGIC;
    signal int_kernel_1_write  : STD_LOGIC;
    signal int_kernel_2_address0 : UNSIGNED(1 downto 0);
    signal int_kernel_2_ce0    : STD_LOGIC;
    signal int_kernel_2_we0    : STD_LOGIC;
    signal int_kernel_2_be0    : UNSIGNED(3 downto 0);
    signal int_kernel_2_d0     : UNSIGNED(31 downto 0);
    signal int_kernel_2_q0     : UNSIGNED(31 downto 0);
    signal int_kernel_2_address1 : UNSIGNED(1 downto 0);
    signal int_kernel_2_ce1    : STD_LOGIC;
    signal int_kernel_2_we1    : STD_LOGIC;
    signal int_kernel_2_be1    : UNSIGNED(3 downto 0);
    signal int_kernel_2_d1     : UNSIGNED(31 downto 0);
    signal int_kernel_2_q1     : UNSIGNED(31 downto 0);
    signal int_kernel_2_read   : STD_LOGIC;
    signal int_kernel_2_write  : STD_LOGIC;
    ...
    component convolution_2d_CTRL_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component convolution_2d_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_0
int_input_0 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 12,
     AWIDTH   => log2(12))
port map (
     ...
     q1       => int_input_0_q1);
-- int_input_1
int_input_1 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 12,
     AWIDTH   => log2(12))
port map (
     ...
     q1       => int_input_1_q1);
-- int_input_2
int_input_2 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 12,
     AWIDTH   => log2(12))
port map (
     ...
     q1       => int_input_2_q1);
-- int_kernel_0
int_kernel_0 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
port map (
     clk0     => ACLK,
     address0 => int_kernel_0_address0,
     ce0      => int_kernel_0_ce0,
     we0      => int_kernel_0_we0,
     be0      => int_kernel_0_be0,
     d0       => int_kernel_0_d0,
     q0       => int_kernel_0_q0,
     clk1     => ACLK,
     address1 => int_kernel_0_address1,
     ce1      => int_kernel_0_ce1,
     we1      => int_kernel_0_we1,
     be1      => int_kernel_0_be1,
     d1       => int_kernel_0_d1,
     q1       => int_kernel_0_q1);
-- int_kernel_1
int_kernel_1 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
port map (
     clk0     => ACLK,
     address0 => int_kernel_1_address0,
     ce0      => int_kernel_1_ce0,
     we0      => int_kernel_1_we0,
     be0      => int_kernel_1_be0,
     d0       => int_kernel_1_d0,
     q0       => int_kernel_1_q0,
     clk1     => ACLK,
     address1 => int_kernel_1_address1,
     ce1      => int_kernel_1_ce1,
     we1      => int_kernel_1_we1,
     be1      => int_kernel_1_be1,
     d1       => int_kernel_1_d1,
     q1       => int_kernel_1_q1);
-- int_kernel_2
int_kernel_2 : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
port map (
     clk0     => ACLK,
     address0 => int_kernel_2_address0,
     ce0      => int_kernel_2_ce0,
     we0      => int_kernel_2_we0,
     be0      => int_kernel_2_be0,
     d0       => int_kernel_2_d0,
     q0       => int_kernel_2_q0,
     clk1     => ACLK,
     address1 => int_kernel_2_address1,
     ce1      => int_kernel_2_ce1,
     we1      => int_kernel_2_we1,
     be1      => int_kernel_2_be1,
     d1       => int_kernel_2_d1,
     q1       => int_kernel_2_q1);
-- int_output_r
int_output_r : convolution_2d_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 16,
     AWIDTH   => log2(16))
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_input_0_read = '0') and (int_input_1_read = '0') and (int_input_2_read = '0') and (int_kernel_0_read = '0') and (int_kernel_1_read = '0') and (int_kernel_2_read = '0') and (int_output_r_read = '0') else '0';
    RVALID    <= RVALID_t;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                ...
                elsif (int_kernel_0_read = '1') then
                    rdata_data <= int_kernel_0_q1;
                elsif (int_kernel_1_read = '1') then
                    rdata_data <= int_kernel_1_q1;
                elsif (int_kernel_2_read = '1') then
                    rdata_data <= int_kernel_2_q1;
...
-- ----------------------- Memory logic ------------------
    ...
    int_input_2_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    -- kernel_0
    int_kernel_0_address0 <= UNSIGNED(kernel_0_address0);
    int_kernel_0_ce0     <= kernel_0_ce0;
    int_kernel_0_we0     <= '0';
    int_kernel_0_be0     <= (others => '0');
    int_kernel_0_d0      <= (others => '0');
    kernel_0_q0          <= STD_LOGIC_VECTOR(RESIZE(int_kernel_0_q0, 32));
    int_kernel_0_address1 <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    int_kernel_0_ce1     <= '1' when ar_hs = '1' or (int_kernel_0_write = '1' and WVALID  = '1') else '0';
    int_kernel_0_we1     <= '1' when int_kernel_0_write = '1' and WVALID = '1' else '0';
    int_kernel_0_be1     <= UNSIGNED(WSTRB);
    int_kernel_0_d1      <= UNSIGNED(WDATA);
    -- kernel_1
    int_kernel_1_address0 <= UNSIGNED(kernel_1_address0);
    int_kernel_1_ce0     <= kernel_1_ce0;
    int_kernel_1_we0     <= '0';
    int_kernel_1_be0     <= (others => '0');
    int_kernel_1_d0      <= (others => '0');
    kernel_1_q0          <= STD_LOGIC_VECTOR(RESIZE(int_kernel_1_q0, 32));
    int_kernel_1_address1 <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    int_kernel_1_ce1     <= '1' when ar_hs = '1' or (int_kernel_1_write = '1' and WVALID  = '1') else '0';
    int_kernel_1_we1     <= '1' when int_kernel_1_write = '1' and WVALID = '1' else '0';
    int_kernel_1_be1     <= UNSIGNED(WSTRB);
    int_kernel_1_d1      <= UNSIGNED(WDATA);
    -- kernel_2
    int_kernel_2_address0 <= UNSIGNED(kernel_2_address0);
    int_kernel_2_ce0     <= kernel_2_ce0;
    int_kernel_2_we0     <= '0';
    int_kernel_2_be0     <= (others => '0');
    int_kernel_2_d0      <= (others => '0');
    kernel_2_q0          <= STD_LOGIC_VECTOR(RESIZE(int_kernel_2_q0, 32));
    int_kernel_2_address1 <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    int_kernel_2_ce1     <= '1' when ar_hs = '1' or (int_kernel_2_write = '1' and WVALID  = '1') else '0';
    int_kernel_2_we1     <= '1' when int_kernel_2_write = '1' and WVALID = '1' else '0';
    int_kernel_2_be1     <= UNSIGNED(WSTRB);
    int_kernel_2_d1      <= UNSIGNED(WDATA);
    -- output_r
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_KERNEL_0_BASE and raddr <= ADDR_KERNEL_0_HIGH) then
                    int_kernel_0_read <= '1';
                else
                    int_kernel_0_read <= '0';
                end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_kernel_0_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_KERNEL_0_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_KERNEL_0_HIGH) then
                    int_kernel_0_write <= '1';
                elsif (WVALID = '1') then
                    int_kernel_0_write <= '0';
                end if;
            end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_KERNEL_1_BASE and raddr <= ADDR_KERNEL_1_HIGH) then
                    int_kernel_1_read <= '1';
                else
                    int_kernel_1_read <= '0';
                end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_kernel_1_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_KERNEL_1_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_KERNEL_1_HIGH) then
                    int_kernel_1_write <= '1';
                elsif (WVALID = '1') then
                    int_kernel_1_write <= '0';
                end if;
            end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_KERNEL_2_BASE and raddr <= ADDR_KERNEL_2_HIGH) then
                    int_kernel_2_read <= '1';
                else
                    int_kernel_2_read <= '0';
                end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_kernel_2_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_KERNEL_2_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_KERNEL_2_HIGH) then
                    int_kernel_2_write <= '1';
                elsif (WVALID = '1') then
                    int_kernel_2_write <= '0';
                end if;
            end if;
...
entity convolution_2d_CTRL_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity convolution_2d_CTRL_s_axi_ram;

architecture behave of convolution_2d_CTRL_s_axi_ram is
