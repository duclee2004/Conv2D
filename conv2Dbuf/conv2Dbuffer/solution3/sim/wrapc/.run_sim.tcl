...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolve_2d.autotvin.dat"
	set constFileTvOut       "convolve_2d.autotvout.dat"
	set constFileHdlTvIn     "convolve_2d.autohdltvin.dat"
	set constFileHdlTvOut    "convolve_2d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
