# ==============================================================
# File generated on Wed Dec 18 17:23:07 +0700 2024
...
$(ObjDir)/test_convolve_2d.cpp_pre.cpp.tb.o : test_convolve_2d.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_convolve_2d.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/convolve_2d.cpp_pre.cpp.tb.o : convolve_2d.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling convolve_2d.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
