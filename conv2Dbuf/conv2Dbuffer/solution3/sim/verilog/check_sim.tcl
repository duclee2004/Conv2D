...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convolve_2d.autotvin_out_stream_V.dat"
         "c.convolve_2d.autotvin_in_stream_V.dat"
         "c.convolve_2d.autotvin_kernel_0_0.dat"
         "c.convolve_2d.autotvin_kernel_0_1.dat"
         "c.convolve_2d.autotvin_kernel_0_2.dat"
         "c.convolve_2d.autotvin_kernel_1_0.dat"
         "c.convolve_2d.autotvin_kernel_1_1.dat"
         "c.convolve_2d.autotvin_kernel_1_2.dat"
         "c.convolve_2d.autotvin_kernel_2_0.dat"
         "c.convolve_2d.autotvin_kernel_2_1.dat"
         "c.convolve_2d.autotvin_kernel_2_2.dat"
         "c.convolve_2d.autotvout_out_stream_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convolve_2d.autotvout_out_stream_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
