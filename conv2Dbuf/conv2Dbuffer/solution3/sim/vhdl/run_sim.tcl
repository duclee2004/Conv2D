...
if {[file isfile convolve_2d.autotvin.dat]} {
	file delete -force convolve_2d.autotvin.dat
}

if {[file isfile convolve_2d.autotvout.dat]} {
	file delete -force convolve_2d.autotvout.dat
}
