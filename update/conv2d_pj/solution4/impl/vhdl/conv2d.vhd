...
port (
    ...
    result_Addr_B : OUT STD_LOGIC_VECTOR (31 downto 0);
    result_EN_B : OUT STD_LOGIC;
    result_Din_B : OUT STD_LOGIC_VECTOR (31 downto 0);
    result_Dout_B : IN STD_LOGIC_VECTOR (31 downto 0);
    result_WEN_B : OUT STD_LOGIC_VECTOR (3 downto 0);
    result_Clk_B : OUT STD_LOGIC;
    result_Rst_B : OUT STD_LOGIC;
...
architecture behav of conv2d is 
    ...
    "conv2d,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.742000,HLS_SYN_LAT=5471,HLS_SYN_TPT=4506,HLS_SYN_MEM=4,HLS_SYN_DSP=6,HLS_SYN_FF=1098,HLS_SYN_LUT=11388,HLS_VERSION=2018_3}";
    ...
    signal load_input_U0_input_r_Addr_A : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_input_r_EN_A : STD_LOGIC;
    signal load_input_U0_input_r_WEN_A : STD_LOGIC_VECTOR (3 downto 0);
    signal load_input_U0_input_r_Din_A : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_input_r_Addr_B : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_input_r_EN_B : STD_LOGIC;
    signal load_input_U0_input_r_WEN_B : STD_LOGIC_VECTOR (3 downto 0);
    signal load_input_U0_input_r_Din_B : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal load_input_U0_buffer_r_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal load_input_U0_buffer_r_ce1 : STD_LOGIC;
    signal load_input_U0_buffer_r_we1 : STD_LOGIC;
    signal load_input_U0_buffer_r_d1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal convolution_kernel_U0_kernel_Addr_A : STD_LOGIC_VECTOR (31 downto 0);
    signal convolution_kernel_U0_kernel_EN_A : STD_LOGIC;
    signal convolution_kernel_U0_kernel_WEN_A : STD_LOGIC_VECTOR (3 downto 0);
    signal convolution_kernel_U0_kernel_Din_A : STD_LOGIC_VECTOR (31 downto 0);
    signal convolution_kernel_U0_kernel_Addr_B : STD_LOGIC_VECTOR (31 downto 0);
    signal convolution_kernel_U0_kernel_EN_B : STD_LOGIC;
    signal convolution_kernel_U0_kernel_WEN_B : STD_LOGIC_VECTOR (3 downto 0);
    signal convolution_kernel_U0_kernel_Din_B : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal write_output_U0_output_r_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal write_output_U0_output_r_ce1 : STD_LOGIC;
    signal write_output_U0_result_Addr_A : STD_LOGIC_VECTOR (31 downto 0);
    signal write_output_U0_result_EN_A : STD_LOGIC;
    signal write_output_U0_result_WEN_A : STD_LOGIC_VECTOR (3 downto 0);
    signal write_output_U0_result_Din_A : STD_LOGIC_VECTOR (31 downto 0);
    signal write_output_U0_result_Addr_B : STD_LOGIC_VECTOR (31 downto 0);
    signal write_output_U0_result_EN_B : STD_LOGIC;
    signal write_output_U0_result_WEN_B : STD_LOGIC_VECTOR (3 downto 0);
    signal write_output_U0_result_Din_B : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal output_t_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal output_t_we1 : STD_LOGIC;
...
begin
    ...
    input_r_Clk_B <= ap_clk;
    input_r_Din_A <= ap_const_lv32_0;
    input_r_Din_B <= ap_const_lv32_0;
    input_r_EN_A <= load_input_U0_input_r_EN_A;
    input_r_EN_B <= load_input_U0_input_r_EN_B;
    input_r_Rst_A <= ap_rst;
    input_r_Rst_B <= ap_rst;
    input_r_WEN_A <= (0=>ap_const_logic_0, others=>'-');
    input_r_WEN_B <= (0=>ap_const_logic_0, others=>'-');
    kernel_Addr_A <= convolution_kernel_U0_kernel_Addr_A;
    kernel_Addr_B <= convolution_kernel_U0_kernel_Addr_B;
    kernel_Clk_A <= ap_clk;
    kernel_Clk_B <= ap_clk;
    ...
    kernel_Rst_A <= ap_rst;
    kernel_Rst_B <= ap_rst;
    kernel_WEN_A <= (0=>ap_const_logic_0, others=>'-');
    kernel_WEN_B <= (0=>ap_const_logic_0, others=>'-');
