...
set portList { 
	...
	{ result_Addr_B sc_out sc_lv 32 signal 1 } 
	{ result_EN_B sc_out sc_logic 1 signal 1 } 
	{ result_WEN_B sc_out sc_lv 4 signal 1 } 
	{ result_Din_B sc_out sc_lv 32 signal 1 } 
	{ result_Dout_B sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 10 }  { output_r_ce0 mem_ce 1 1 }  { output_r_q0 mem_dout 0 32 }  { output_r_address1 MemPortADDR2 1 10 }  { output_r_ce1 MemPortCE2 1 1 }  { output_r_q1 MemPortDOUT2 0 32 } } }
	result { bram {  { result_Addr_A MemPortADDR2 1 32 }  { result_EN_A MemPortCE2 1 1 }  { result_WEN_A MemPortWE2 1 4 }  { result_Din_A MemPortDIN2 1 32 }  { result_Dout_A MemPortDOUT2 0 32 }  { result_Addr_B MemPortADDR2 1 32 }  { result_EN_B MemPortCE2 1 1 }  { result_WEN_B MemPortWE2 1 4 }  { result_Din_B MemPortDIN2 1 32 }  { result_Dout_B MemPortDOUT2 0 32 } } }
}
