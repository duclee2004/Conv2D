...
set C_modelArgList {
	{ output_r int 32 regular {array 900 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ result_address0 sc_out sc_lv 10 signal 1 } 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 10 }  { output_r_ce0 mem_ce 1 1 }  { output_r_q0 mem_dout 0 32 } } }
