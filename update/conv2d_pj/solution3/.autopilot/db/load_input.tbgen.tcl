...
set C_modelArgList {
	...
	{ buffer_r int 32 regular {array 1024 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 10 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 32 } } }
}
